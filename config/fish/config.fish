...
fish_add_path -p $GOPATH/bin $HOME/.local/bin $HOME/.krew/bin /usr/lib/node_modules/.bin $HOME/.pub-cache/bin $HOME/.cargo/bin /opt/homebrew/Caskroom/sqlcl/23.2.0.178.1027/sqlcl/bin /opt/homebrew/opt/mysql-client/bin $HOME/.local/share/nvim/mason/bin
